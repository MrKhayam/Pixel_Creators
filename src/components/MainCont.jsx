  ...
  return (
    <>
      <div className="w-full h-auto flex flex-col mt-12 items-center justify-center">
        ...
        <button className='text-white mt-12 text-lg rounded-md font-semibold bg-gradient-to-br from-[#171233] via-[#43107e] to-[#171233] px-14 py-4 transition-all duration-150 hover:scale-95'>Visit Portfolio</button>
      </div>
    </>
  )
}
