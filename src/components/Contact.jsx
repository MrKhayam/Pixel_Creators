...
const WhatsAppButton = () => {
  ...
  const message = encodeURIComponent('Hello, I would like to know more about your product.');
  ...
  return (
    <button
      onClick={handleClick}
      className='text-white mt-4 text-lg rounded-md font-semibold cursor-pointer bg-green-600 px-[103px] py-4 transition-all duration-150 hover:scale-95'
    >
      WhatsApp
    </button>
  );
  ...
  return (
    <div className="h-auto w-[90%] m-auto mt-20 flex flex-col items-center justify-center gap-12">
      ...
      <div className="form flex flex-col gap-1 items-center justify-center w-[90%] h-auto ">
        <button className='text-white mt-0 text-lg rounded-md font-semibold bg-gradient-to-br from-[#171233] via-[#43107e] to-[#171233]  w-72 py-4 cursor-default'>
          Let's Talk
        </button>
        <WhatsAppButton />
      </div>
