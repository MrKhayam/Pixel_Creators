  ...
  return (
    <>
      <div className="h-auto w-[90%] m-auto mt-20 flex flex-col items-center justify-center gap-12">
        ...
        <button className='text-white mt-0 text-lg rounded-md font-semibold bg-gradient-to-br from-[#171233] via-[#43107e] to-[#171233] px-28 py-4 cursor-default'>Let's Talk</button>
        <button disabled className='text-white mt-4 text-lg rounded-md font-semibold cursor-pointer bg-green-600 px-[108px] py-4 transition-all duration-150 hover:scale-95'>Whatsapp</button>
        </div>
      </div>
    </>
  )
