  ...
  return (
    <>
      <div className="h-auto w-[90%] m-auto mt-20 flex flex-col items-center justify-center gap-12">
        ...
        <button disabled className='text-white mt-4 text-lg rounded-md font-semibold cursor-pointer bg-green-600 px-[103px] py-4 transition-all duration-150 hover:scale-95'>Whatsapp</button>
        </div>
      </div>
    </>
  )
